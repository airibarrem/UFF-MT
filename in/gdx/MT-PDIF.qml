...
<qgis version="2.8.1-Wien" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="PDIF">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="PDIF" symbollevels="0" type="graduatedSymbol">
    <ranges>
      <range render="true" symbol="0" lower="0.000000" upper="5.000000" label=" 0.0 - 5.0 "/>
      <range render="true" symbol="1" lower="5.000000" upper="33.000000" label=" 5.0 - 33.0 "/>
      <range render="true" symbol="2" lower="33.000000" upper="95.000000" label=" 33.0 - 95.0 "/>
      <range render="true" symbol="3" lower="95.000000" upper="99.990000" label=" 95.0 - 100.0 "/>
      <range render="true" symbol="4" lower="99.990000" upper="1000000000.000000" label=" 100.0 - 1000000000.0 "/>
    </ranges>
    <symbols>
